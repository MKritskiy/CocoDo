...
public class DetailsTaskFragment extends DialogFragment
    ...
    public interface OnFragmentButtonClickListener{
        void addTaskButtonClick(String taskName, String taskDescription, String taskTime);
    }

    private AddTaskFragment.OnFragmentButtonClickListener fragmentButtonClickListener;
    @Override
    public void onAttach(@NonNull Context context) {
        super.onAttach(context);
        try{
            fragmentButtonClickListener = (AddTaskFragment.OnFragmentButtonClickListener) context;
